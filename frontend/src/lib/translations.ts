  ...
  en: {
    ...
    users: {
      ...
      states: {
        ...
        empty_subtitle: "Start by inviting new members to your team.",
        invite_success: "Invitation sent successfully!",
        delete_success: "User removed successfully.",
        error_invite: "Failed to process request.",
        error_delete: "Failed to remove user.",
      }
    },
    settings: {
      tabs: {
